...
for i_peak = 1:length(params.peaks)
    ...
    for i_sub = subs
        ...
        for i_trigger = 1:n_triggers
            pos_squidmag(i_trigger,:) = mne_squidmag{i_sub}{i_trigger,i_peak}.loc;
            pos_squidgrad(i_trigger,:) = mne_squidgrad{i_sub}{i_trigger,i_peak}.loc;
            pos_opm(i_trigger,:) = mne_opm{i_sub}{i_trigger,i_peak}.loc;
            ...
            pow_squidmag(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.pow;
            pow_squidgrad(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.pow;
            pow_opm(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.pow;
    
            mom_squidmag(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.mom;
            mom_squidgrad(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.mom;
            mom_opm(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.mom;
    
            lat_squidmag(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.latency;
            lat_squidgrad(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.latency;
            lat_opm(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.latency;
    
            fahm_opm(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.fahm; % mean distance from center of phalanges
            fahm_squidmag(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.fahm; % mean distance from center of phalanges
            fahm_squidgrad(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.fahm; % mean distance from center of phalanges

            targetregion_opm(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.target_region; % mean distance from center of phalanges
            targetregion_squidmag(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.target_region; % mean distance from center of phalanges
            targetregion_squidgrad(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.target_region; % mean distance from center of phalanges
    
            overlap_opm_squidmag(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.overlap_squidmag/mne_opm{i_sub}{i_trigger,i_peak}.fahm;
            overlap_opm_squidgrad(i_sub,i_trigger) = mne_opm{i_sub}{i_trigger,i_peak}.overlap_squidgrad/mne_opm{i_sub}{i_trigger,i_peak}.fahm;
            overlap_squidmag_squidgrad(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.overlap_squidgrad/mne_squidmag{i_sub}{i_trigger,i_peak}.fahm;
            overlap_squidmag_opm(i_sub,i_trigger) = mne_squidmag{i_sub}{i_trigger,i_peak}.overlap_opm/mne_squidmag{i_sub}{i_trigger,i_peak}.fahm;
            overlap_squidgrad_squidmag(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.overlap_squidmag/mne_squidgrad{i_sub}{i_trigger,i_peak}.fahm;
            overlap_squidgrad_opm(i_sub,i_trigger) = mne_squidgrad{i_sub}{i_trigger,i_peak}.overlap_opm/mne_squidgrad{i_sub}{i_trigger,i_peak}.fahm;
        end
    end
    ...
    for i_trigger = 1:n_triggers
        ...
        saveas(h, fullfile(base_save_path, 'figs', ['mne_dist_vs_sub-' params.trigger_labels{i_trigger} '_' peak_label cov '.jpg']))
        close
    end
    ...
    for i_trigger = 1:n_triggers
        ...
        saveas(h, fullfile(base_save_path, 'figs', ['mne_fahm_vs_sub-' params.trigger_labels{i_trigger} '_' peak_label cov '.jpg']))
        close
    end
    disp('done')
end
